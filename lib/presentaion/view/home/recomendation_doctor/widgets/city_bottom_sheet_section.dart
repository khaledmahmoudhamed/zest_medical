    ...
    return SizedBox(
      ...
      child: BlocBuilder<DoctorCubit, DoctorState>(
        builder: (BuildContext context, DoctorState state) {
          ...
          final Map<int, String> unCity = {};
          for (var doc in state.allDoctorsList) {
            unCity[doc.city.id] = doc.city.name;
          }

          final uniqueIds = unCity.keys.toList();
          final uniqueNames = unCity.values.toList();
          ...
          return ListView.builder(
            ...
            itemBuilder: (context, index) {
              int currentId = uniqueIds[index];
              String currentName = uniqueNames[index];
              bool isChecked = state.checkedCityId == currentId;
              return InkWell(
                onTap: () {
                  int? newId = isChecked ? null : currentId;
                  context.read<DoctorCubit>().filterDoctorsByCity(newId!);
                },
                child: Container(
